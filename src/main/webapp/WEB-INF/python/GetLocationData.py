                ...
                try:
                    ...
                    if jsonData.keys()[0] == 'locationstream':
                        ...
                        for index in range(len(jsonList)):                            
                            ...
                            #cursor.execute("replace into locationPhone (IdType,Timestamp,datatype,x,y,z,mmes1,enbs1,enbid,userid) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",sqlparam)
                    ...
                    if jsonData.keys()[0] == 'locationstreamanonymous':
                        ...
                        for index in range(len(jsonList)):                            
                            ...
                            #cursor.execute("insert into location"+dataStr+" (IdType,Timestamp,datatype,x,y,z,mmes1,enbs1,enbid,userid) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",sqlparam)
