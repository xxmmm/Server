...
//        						"bVisible": false,
        	                ...
        	                },
        					{
        	                    ...
        	                    "mRender": function ( data, type, full ) {
        	                    	var html = "" +
        	                    		'<input type="button" style="width: 53px;height:30px;font-size: 13px;font-family:inherit;" data-type="fuzhi" data-placeid="'+full.placeId+'" data-shopId="'+full.shopId+'" data-id="'+full.floorid+'" value="'+i18n_fuzhi+'">' +
        	                    		'<input type="button" data-type="edt" style="width: 54px;height:30px;font-size: 13px;font-family:inherit;" data-placeid="'+full.placeId+'" data-shopId="'+full.shopId+'" data-xSpot="'+full.xSpot+'" data-ySpot="'+full.ySpot+'" data-floorno="'+full.floorNo+'" value="'+i18n_edit+'" id="'+full.id+' ">' +
        	                    		'<input type="button" data-type="del" style="width: 54px;height:30px;font-size: 13px;font-family:inherit;" data-floorNo="'+full.floorNo+'" data-shopId="'+full.shopId+'" id="'+full.id+'" data-id="'+full.id+'" data-xSpot="'+full.xSpot+'" data-ySpot="'+full.ySpot+'" value="'+i18n_delete+'">'+
        	                    		'<a data-type="preview" role="button" class="btn"  style="font-size:13px;" data-floorNo="'+full.floorNo+'" id="'+full.id+'"  data-xSpot="'+full.xSpot+'" data-ySpot="'+full.ySpot+'" data-pictrue="'+full.pictruePath+'" data-movie="'+full.moviePath+'">'+i18n_Preview+'</a>';
        	                        return html;
        	                      }
        	                }
        				],
