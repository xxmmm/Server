$("#exportButton").click(function(e){
	...
	window.location.href = basePath +'accuracy/api/exportCodeTemplate';
	})
	...
	return {
		initTable:function(){
			oTable = $('#table').dataTable( {
				"bProcessing": true,
				"sAjaxSource": "/sva/accuracy/api/getTableData",
				"sServerMethod": "POST",
				...
				"aoColumnDefs": [
					...
					{ 
						...
						"mRender": function ( data, type, full ) {
							if(data == "1"){
								return i18n_accuracy_dynamic;
							}else{
								return i18n_accuracy_static;
							}
						}
					},
					{ 
